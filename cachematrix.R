...
## This function checks to see if the matrix has a cached inverse, to save computation time. If there is no cached inverse, the function calculates the inverse and sets it via "set inverse"
